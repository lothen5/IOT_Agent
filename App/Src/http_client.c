              ...
              uint16_t response_size)
{
    ...
    ret = W5500_Socket0_Send((const uint8_t *)header, (uint16_t)strlen(header));
    ...
    ret = W5500_Socket0_Send((const uint8_t *)body, (uint16_t)body_len);
    ...
    printf("HTTP POST sent, body len=%lu\r\n", body_len);
    ...
    printf("HTTP POST done, response len=%d\r\n", total_len);
